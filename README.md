...
* Tags of the form MAJOR.MINOR.PATCH (such as 11.2) indicate the SemVer of 
  the __Debian__ image used as the base.
* Tags of the form MAJOR.MINOR (e.g., 11) correspond to the most recent patch level of
  the __Debian__ image used as the base. For example, if 11.2 is the latest
...
* Tags of the form MAJOR (e.g., 11) correspond to the most recent patch level of
  ...
  For example, if 11.2 is the latest release, then 11 maps to this as well.
